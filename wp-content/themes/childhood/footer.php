        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <div>
                  <?php
                    echo do_shortcode( '[contact-form-7 id="160" title="Попап форма - вопрос"]' );
                  ?>
                </div>
            </div>
        </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<?php the_field('links_inst_href', 2); ?>" class="footer__social-item">
                            ...
                            <a href="<?php the_field('links_fb_href', 2); ?>" class="footer__social-item">
                            ...
                            <a href="<?php the_field('links_yt_href', 2); ?>" class="footer__social-item">
